...
**All versions — log scale (each block ≈ 10× reduction):**
```
Version  Total      ██ = log₁₀(time), proportional                          Speedup
───────  ─────────  ───────────────────────────────────────────────────────  ───────
v0       145.25s    ██████████████████████████████████████████████████████    1.0×
v1         8.06s    ██████████████████████                                   18.0×
v2         5.83s    ████████████████████                                     24.9×
...
**v1 → v3 zoomed — linear scale (each block ≈ 0.13s):**
```
Version  Total      ██ = proportional to time                                Speedup
───────  ─────────  ───────────────────────────────────────────────────────  ───────
v1         8.06s    ████████████████████████████████████████████████████████  18.0×
v2         5.83s    ████████████████████████████████████████                 24.9×
v3         5.58s    ██████████████████████████████████████                   26.0×
